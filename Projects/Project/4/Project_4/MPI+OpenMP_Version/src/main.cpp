    ...
    if (0 == rank) {
        ...
        context.run([&](graphic::GraphicContext *context [[maybe_unused]], SDL_Window *) {
            ...
            if (!finished) {
                ...
                /* calculate the value */
                root_finish = hdist::calculate(current_state, grid, rank, num_processes, threadnum);
                ...
                if(all_finished == 1)std::cout << "all_finished is" << all_finished << std::endl;
        ...
        while(true){
            ...
            other_finished = hdist::calculate(current_state, grid,rank,num_processes,threadnum);
            // if(other_finished == 1) std::cout <<  "my rank is " << rank <<" my finish is: " << other_finished << std::endl;
